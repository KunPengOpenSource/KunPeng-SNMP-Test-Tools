 ...
 * Changes:
 * Nov/20, 2008
 *  FxCop fix: renamed argument from byteCount to count in RemoveBeginning and RemoveEnd
 *  renamed argument from length to count in Remove method
 *  FxCop fix: too many to list. Mostly exception call cleanups
 * Nov/29, 2008
 *  added method Set(int, byte) positional byte buffer value set operation
 *  removed exception throw in this[int] operator and simplified code
 */
using System;
