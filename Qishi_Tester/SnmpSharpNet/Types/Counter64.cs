...
namespace SnmpSharpNet
{
	...
	public class Counter64 : AsnType, IComparable<UInt64>, IComparable<Counter64>
	{
		...
		public override int decode(byte[] buffer, int offset)
		{
			...
			byte[] asnBuf = new byte[headerLength];
			if (headerLength == 9)
			{
		...
		/// </summary>
		/// <remarks>Compare two Couner64 class values and return true if first class value is greater then second.</remarks>
		...
		/// Less then operator
		/// </summary>
		/// <remarks>Compare two Couner64 class values and return true if first class value is less then second.</remarks>
		/// <param name="first">First class</param>
		/// <param name="second">Second class</param>
