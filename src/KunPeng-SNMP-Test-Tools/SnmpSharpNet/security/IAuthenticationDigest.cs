...
namespace SnmpSharpNet
{
	...
	public interface IAuthenticationDigest
	{
		...
		/// <param name="authFieldOffset">Offset within the message to store authentication parameters values</param>
		void authenticateOutgoingMsg(byte[] userPassword, byte[] engineId, MutableByte wholeMessage, int authFieldOffset);
